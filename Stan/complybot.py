...
st.set_page_config(page_title='Wolfie Chatbot')
st.title("Ask Wolfie")
...
if user_query is not None and user_query != "":
    ...
    with st.chat_message("AI"):
        response, source = st.write_stream(get_response(user_query, st.session_state.chat_history, country, model_types["claude-opus"]))
        st.write("Please verify the answer generated by Wolfie to ensure you are being compliant with written documents.")
